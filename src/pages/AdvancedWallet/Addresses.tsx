...
import { paper_A, result_A } from '@/state/walletAdvanced';
import { resetPaper, showPaper } from '@/state/walletAdvanced/paper';
...
export default function Addresses() {
    ...
    useEffect(() => {
        result.length || navigate('/wallet/advanced');
    }, [ result, navigate ]);
    ...
    return (
        <Wrapper>
            <Title>
                {t('walletAdvanced.addresses.title')}
            </Title>
